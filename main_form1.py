...
class Ui_Autorization(object):
    def setupUi(self, Autorization):
        ...
        self.reg_rep_pas.setEchoMode(QtWidgets.QLineEdit.Password)
        ...
        self.reg_pas.setEchoMode(QtWidgets.QLineEdit.Password)
        ...
        self.show_error.setGeometry(QtCore.QRect(110, 400, 601, 61))
        ...
        self.aut_pass.setEchoMode(QtWidgets.QLineEdit.Password)
        ...
        self.aut_check = QtWidgets.QCheckBox(Autorization)
        self.aut_check.setGeometry(QtCore.QRect(420, 260, 161, 21))
        self.aut_check.setStyleSheet("font: 10pt \"MS Shell Dlg 2\";")
        self.aut_check.setObjectName("aut_check")
        self.reg_check = QtWidgets.QCheckBox(Autorization)
        self.reg_check.setGeometry(QtCore.QRect(1030, 260, 141, 21))
        self.reg_check.setStyleSheet("font: 10pt \"MS Shell Dlg 2\";\n"
"font: 9pt \"MS Shell Dlg 2\";")
        self.reg_check.setObjectName("reg_check")
        self.reg_pas_check = QtWidgets.QCheckBox(Autorization)
        self.reg_pas_check.setGeometry(QtCore.QRect(1030, 320, 141, 21))
        self.reg_pas_check.setStyleSheet("font: 10pt \"MS Shell Dlg 2\";\n"
"font: 9pt \"MS Shell Dlg 2\";")
        self.reg_pas_check.setObjectName("reg_pas_check")
    ...
    def retranslateUi(self, Autorization):
        ...
        self.aut_check.setText(_translate("Autorization", "Показать пароль"))
        self.reg_check.setText(_translate("Autorization", "Показать пароль"))
        self.reg_pas_check.setText(_translate("Autorization", "Показать пароль"))
